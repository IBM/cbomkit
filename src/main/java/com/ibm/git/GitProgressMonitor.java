...
public class GitProgressMonitor implements ProgressMonitor {
    ...
    public void beginTask(String s, int i) {
        ...
        messageHandling.accept(PREFIX_CLONING_GIT_REPOSITORY + s + " " + 0 + "%");
    }
    ...
    public void update(int i) {
        ...
        if (i == 1) {
            currentTaskWork++;
            percentage = calculatePercentage(currentTaskWork, currentTaskTotalWork);
            if (percentage % 5 == 0) {
                messageHandling.accept(
    ...
    @Override
    public void endTask() {
        messageHandling.accept(PREFIX_CLONING_GIT_REPOSITORY + this.currentTaskTitle + " done");
    }
